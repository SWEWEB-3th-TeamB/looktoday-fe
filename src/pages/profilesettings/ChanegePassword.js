...
const ChangePassword = () => {
  return (
    <div className="wrap">
      ...
      <div className='chanage-password-bottom'>
        <div className='change-password-btn'>
          <AuthButton to='/change-password-complete' text='완료' />
        </div>
        <div className='change-password-links'>
          <div className='change-password-link'><a href='/login'>로그인</a></div>ㅣ<div className='change-password-link'><a href='/sign-up'>회원가입</a></div>
        </div>
      </div>
